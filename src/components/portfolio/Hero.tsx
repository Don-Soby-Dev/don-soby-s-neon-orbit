...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-8 min-w-0">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.15fr_auto] min-w-0">
          {/* Main Editorial Copy */}
          <div className="min-w-0">
            {/* Eyebrow */}
            <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 backdrop-blur-md">
              <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#00d4ff] animate-pulse" />
              <span className="font-mono text-xs tracking-wide text-white/80">
                ...
                <span className="sm:hidden">Don Soby · Full Stack Developer · Kerala</span>
              </span>
            </div>

            {/* Headline */}
            <h1 className="mt-8 font-display text-4xl font-bold tracking-tight text-white sm:text-7xl lg:text-[5.25rem] lg:leading-[1.02]">
              Architecture is{" "}
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4 sm:gap-6 border-t border-white/8 pt-8">
              <div className="flex items-center gap-2 font-mono text-xs text-white/60">
                <ShieldCheck className="h-4 w-4 text-[#00d4ff] shrink-0" />
          ...
          {/* Profile Visual */}
          <div className="relative mx-auto lg:mx-0 max-w-full">
            ...
            <div className="relative rounded-[2.25rem] border border-white/15 bg-white/[0.03] p-2 backdrop-blur-xl shadow-2xl">
              <img
                src="/don-soby.jpg"
                alt="Don Soby"
                className="h-64 w-64 rounded-[1.75rem] object-cover sm:h-80 sm:w-80 shadow-inner"
              />

              {/* Status Badge Over Image */}
              <div className="absolute bottom-5 left-4 right-4 sm:left-5 sm:right-5 flex items-center justify-between rounded-xl border border-white/15 bg-[#030508]/85 px-3 py-2 backdrop-blur-md">
